"""
Q Score arithmetic for the deployed API.

COPY OF src/quizgen/qscore.py, KEPT IDENTICAL BELOW THIS HEADER.
...
by a comment — tests/test_qscore_parity.py compares the two files and fails if they
diverge. If you change one, change both; the test will tell you if you forget.

The original is authoritative. Edit src/quizgen/qscore.py and copy it here.
"""
